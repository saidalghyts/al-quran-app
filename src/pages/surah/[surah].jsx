      ...
      <div
        ...
        <div className="modal-dialog modal-dialog-scrollable relative w-auto pointer-events-none">
          <div className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto dark:bg-slate-900 bg-white bg-clip-padding rounded-md outline-none text-current">
            ...
            <div
              id="theModal"
              className="modal-body relative p-4 text-justify ">
              {findBookmark.map((x) => {
                return (
                  <div
                    key={x.nomor}
                    className="p-4 bg-slate-50 dark:bg-slate-800 rounded-lg mb-4 flex justify-between">
                    <div>
                      <h2 className="recipe__card__title">
                        {data1.nama_latin}
                      </h2>
                      <h4 className="recipe__card__desc">Ayat {x.nomor}</h4>
                    </div>
                    <button
                      className="dark:bg-slate-900 rounded-md p-2 ml-2"
                      onClick={() => removeBookmark(x.nomor)}>
                      Remove
                    </button>
                  </div>
                );
                  ...
                  <div className="pb-6 flex justify-between">
                    ...
                    <div className="flex">
                      <span className="cursor-pointer duration-200">
                        <svg
                          onClick={() => addToBookmark(isi.nomor)}
